...
class MyNewHelp(commands.MinimalHelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        em = discord.Embed(title="Command List", description=f"This is the command list of {self.bot.user.name}'s commands. Click the numbers to go to different pages, or click the house to come back here.\n"+'\n'.join(cognames), color=discord.Color.blue())
